...
const heroTextContent = 'Deyaaa is Love';
...
function initiatePlayback() {
    ...
    bgMusic.play().then(() => {
        ...
        bgMusic.muted = false; // Unmute if it starts playing
        updateMusicButton();
    }).catch((error) => {
        // Auto-play prevented, show the music button
        console.error("Auto-play prevented: ", error);
        musicButton.style.display = "inline-block";

        // Add a user interaction listener to start playback
        document.addEventListener('click', userInitiatedPlayback, { once: true });
    });
}
...
const quotes = [
    "Go Go Go Deyaaaaa",
    "You Can Do It Deyaaaaa",
    "I'll be there to support you deyyyy",
];
